...
CREATE INDEX IF NOT EXISTS idx_content_search_workspace_recent ON content_search(workspace_id, visibility, updated_at DESC);
CREATE INDEX IF NOT EXISTS idx_content_search_owner_type ON content_search(owner_user_id, item_type, updated_at DESC);
CREATE INDEX IF NOT EXISTS idx_content_search_visibility ON content_search(visibility, updated_at DESC);
CREATE INDEX IF NOT EXISTS idx_content_search_title ON content_search(title);
CREATE INDEX IF NOT EXISTS idx_feed_rank_cache_user_expiry ON feed_rank_cache(user_id, topic_key, expires_at, rank_score DESC);
CREATE INDEX IF NOT EXISTS idx_feed_rank_cache_lesson ON feed_rank_cache(lesson_id, created_at DESC);
...
CREATE INDEX IF NOT EXISTS idx_collaboration_sessions_type_status ON collaboration_sessions(session_type, status, started_at DESC);
CREATE INDEX IF NOT EXISTS idx_collaboration_sessions_content ON collaboration_sessions(content_item_id, started_at DESC);
CREATE INDEX IF NOT EXISTS idx_collaboration_events_session ON collaboration_events(session_id, created_at DESC);
CREATE INDEX IF NOT EXISTS idx_collaboration_events_type ON collaboration_events(event_type, created_at DESC);
CREATE INDEX IF NOT EXISTS idx_client_mutations_user_status ON client_mutations(user_id, status, server_received_at DESC);
CREATE INDEX IF NOT EXISTS idx_client_mutations_content ON client_mutations(content_item_id, server_received_at DESC);
