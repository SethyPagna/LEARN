...
const publicProjectDocs = [
  "README.md",
  "ops/docs/roadmap/plan.md",
  "ops/docs/roadmap/progress.md",
  "ops/docs/operations/change-control.md",
]
...
test("README uses the pinned Wrangler command path", () => {
  ...
  assert.match(text, /ops\\run\\bin\\pnpm\.cmd exec wrangler secret put SESSION_SECRET/)
})
